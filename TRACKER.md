...
| Desktop editor    | ✅     | One injected React editor for desktop/browser with project/archive/artifact/subtitle/template/export workflows; 138 tests       |
...
| Configurable aspect ratio (9:16, 3:4, 4:5, 16:9)                                                                                                                                          | ✅     | Filmora-style canvas selector is always visible in the top toolbar: named Reel/Short, Horizontal Video, Social Portrait and Classic Portrait layouts update the same persisted project ratio used by preview and export; Ctrl+Shift+R toggles portrait/horizontal                                                                                                  |
...
| AI transcription runtime                                                       | 🔨     | Accepted ADR-0007 implemented for Windows CPU: pinned/checksummed whisper.cpp v1.8.6 sidecar packaging, Rust supervision, cancellation, staging cleanup, full-JSON timestamp parsing and real progress events. macOS/Linux and measured GPU variants remain distribution work                       |
