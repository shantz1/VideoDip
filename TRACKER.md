...
| ----------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------- |
| Timeline          | ✅     | Generic ordered tracks, visual/audio settings, keyframes, timing invariants and split/trim rebasing; 50 tests                   |
| Shared            | ✅     | Segregated ports, opaque locators, versioned project plus subtitle persistence schemas, typed transcription readiness; 40 tests |
| Media Engine      | ✅     | Portable media, probing, cancellable artifacts, atomic cache, export compiler and named delivery presets; 37 tests              |
| Renderer          | ✅     | Serializable composition contract for transformed/animated/audio clips and styled word-timed subtitles; 9 tests                 |
| Desktop editor    | ✅     | One injected React editor for desktop/browser with project/archive/artifact/subtitle/template/export workflows; 144 tests       |
...
| Subtitle Engine   | ✅     | Framework-free cue/word/style/timing operations plus validated SRT, WebVTT and ASS interchange; 8 tests                         |
| Template Engine   | ✅     | Strict data-only JSON definitions and deterministic typed parameter resolution; 2 tests                                         |

Review sequence completed 2026-07-17 and extended 2026-07-18. Final gate: all 25 Turbo tasks, optimized
...
| Configurable project aspect ratio (9:16, 3:4, 4:5, 16:9)                                                                                                                                  | ✅     | Settings changes the persisted project ratio consumed by preview and export; this content setting is intentionally independent of the editor workspace arrangement                                                                                                                                                                                                 |
...
| `packages/media-engine` — FFmpeg export orchestration                                                                                                                                     | 🔨     | Pure validated argument compiler, task-scoped streamed progress, user cancellation, pre-spawn race handling and a 30-minute safety timeout are complete; multi-stream/audio-aware graphs remain                                                                                                                                                                    |
...
| Item                                                                           | Status | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/subtitle-engine` — segments, words, styling, timing (framework-free) | ✅     | Framework-free document operations, timing/overlap/word validation, undoable desktop store and persisted project boundary; 8 tests                                                                                                                                                                                                                                                                                                                                                |
| AI transcription runtime                                                       | 🔨     | Accepted ADR-0007 implemented for Windows CPU: pinned/checksummed whisper.cpp v1.8.6 sidecar packaging, Rust supervision, cancellation, staging cleanup, full-JSON timestamp parsing and real progress events. The reported 15% stall is fixed by streaming carriage-return progress before process exit; zero-length whisper.cpp control-token offsets no longer reject otherwise valid cues. macOS/Linux and measured GPU variants remain distribution work; 17 Rust tests pass |
...
| Multi-platform export presets (TikTok/Reels/Shorts sizes, bitrates) | ✅     | Typed TikTok/Reels/Shorts/square/landscape presets drive geometry, fps, CRF, encoder speed and audio bitrate from Settings                                                                                                                                                   |
